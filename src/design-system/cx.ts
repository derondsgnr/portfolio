...
export const formCx = {
  ...
  textarea:
    "w-full px-4 py-3 bg-white/[0.03] border border-white/[0.08] text-white text-sm focus:outline-none focus:border-[#ECFF95]/50 transition-colors placeholder:text-white/20 resize-y font-['Instrument_Sans']",
  select:
