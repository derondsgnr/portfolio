...
function CaseStudyImage({
  ...
  const canExpand = expandable && !!src?.trim() && !!media;
  return (
        ...
        <div>
          ...
          >
            <DeviceMockup device={slide.device}>
              <CaseStudyImage src={slide.image} alt={slide.headline || "Screen mockup"} className="w-full h-auto" wrapperClassName="w-full" expandable />
            </DeviceMockup>
            <ScanLines />
          ...
          {slide.screens.map((screen, i) => (
            ...
            >
              <DeviceMockup device={screen.device || "phone"}>
                <CaseStudyImage src={screen.image} alt={screen.label || `Screen ${i + 1}`} className="w-full h-auto" wrapperClassName="w-full" expandable />
              </DeviceMockup>
              {screen.label && (
              ...
              {(animateMarquee ? [...slide.mockups, ...slide.mockups] : slide.mockups).map((mockup, idx) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => media?.openAt(mockup.image)}
                  >
