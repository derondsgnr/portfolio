...
export const DEFAULT_PROJECTS = [
  { id: "01", title: "Bridgepay", category: "Fintech", year: "2025", description: "Shaping a new escrow sub-product from the ground up — making online buying and selling safer for Nigerians moving money globally.", image: ph("Bridgepay · Escrow & FX", 1080, 608), slug: "bridgepay" },
  { id: "02", title: "Urban", category: "Transportation", year: "2025", description: "Redesigning both rider and driver apps for a Nigerian interstate transport platform — modern, simple, safe.", image: ph("Urban · Rider & driver", 1080, 608), slug: "urban" },
  { id: "03", title: "Customer Support Platform", category: "B2B", year: "2025", description: "PowerCS — helping a founder turn a big vision into a real, manageable MVP, from PRD to clear flows and dashboard.", image: ph("PowerCS · Customer support", 1080, 608), slug: "customer-support-platform" },
